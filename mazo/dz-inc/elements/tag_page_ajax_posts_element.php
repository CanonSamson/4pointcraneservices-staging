<div class="loadmore-content" id='masonry'>					
	...
	/* Post Sorting */
	   $sorting_on = mazo_get_opt('tag_page_sorting_on');
	  
	  $orderby = $order = '';
	  
	  if($sorting_on)
			{
				$sorting	= mazo_get_opt('tag_page_sorting');
...
<a href="javascript:void(0);" class="btn shadow-primary btn-primary btn-rounded btn-ov-secondary loadmore-btn common-page-dz-load-more dz-load-more"  	data-object-data = "<?php echo esc_js($tag_id);?>" 
