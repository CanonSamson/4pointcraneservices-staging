...
<header class="site-header mo-left header style-1">
	<?php get_template_part('dz-inc/elements/header_top_bar5'); ?>	
	
	<!-- Main Header -->
	<div class="<?php echo esc_attr($header_sticky_class); ?> main-bar-wraper navbar-expand-lg text-black">
					...
					<div class="extra-nav">
						<div class="extra-cell">
							...
							<?php if(!empty($header_button_1_text)) { ?>
								<a href="<?php echo esc_url($header_button_1_url); ?>" target="<?php echo esc_attr($header_button_1_target); ?>" class="btn shadow-primary btn-secondary btn-quote">
