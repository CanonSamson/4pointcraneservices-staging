...
<div id="post-<?php the_ID(); ?>" <?php echo post_class('m-b30' . $no_image_class.' '.$class); ?>>
	<div class="dz-card blog-grid style-3 aos-item" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="<?php echo esc_attr($animation_time); ?>">
