<?php
	...
	if($service_listing_3_element_posts_in_categories && !empty($service_listing_3_element_posts_in_categories[0])) {
		
		$service_listing_3_element_posts_in_categories1 = mazo_get_cat_id_by_slug($service_listing_3_element_posts_in_categories,'service_category');
		...
		$service_listing_3_element_posts_in_categories = implode(',',$service_listing_3_element_posts_in_categories1);
	}
	...
	$mazo_query_result['posts_per_page'] = $service_listing_3_element_no_of_posts;	
	$mazo_query_result['current_page'] = $page_no;
	$mazo_query_result['title_text_limit'] = $service_listing_3_element_text_limit;
...
?>
<!-- Blog -->
<div class="section-full" id="DZServiceListingElement3"> 
		
		<!-- Left part start -->
			<div <?php if(!empty($blog_view_container)){ ?> id="<?php echo esc_attr($blog_view_container) ?>" <?php } ?> class="row spno about-industry">
			...
			<?php
				if($service_listing_3_element_pagination_style == 'load_more')
				{
					...
					?>
					<!-- Pagination start -->
					<div class="reload-btn text-center mb-4 mt-4">
