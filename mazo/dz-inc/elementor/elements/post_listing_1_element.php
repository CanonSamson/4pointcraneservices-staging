<?php
	...
	if($post_listing_1_element_posts_in_categories) {
	...
	if($post_listing_1_element_only_featured_posts == 'yes') 
	{ 		
	...
	if($post_listing_1_element_selected_sidebar == 'No_Sidebar' || !is_active_sidebar( $post_listing_1_element_selected_sidebar ) || !mazo_is_theme_sidebar_active())
	{
	...
	$mazo_query_result['posts_per_page'] = $post_listing_1_element_no_of_posts;	
	$mazo_query_result['current_page'] = $page_no;
	$mazo_query_result['side_bar'] = $post_listing_1_element_selected_sidebar;
	$mazo_query_result['title_text_limit'] = $post_listing_1_element_text_limit;
...
?>
<!-- Blog -->
<section class="content-inner" id="DZPostListingElement1">
  <div class="container">
    <?php if(!empty($post_listing_1_element_title)){ ?>
		<div class="section-head style-1 text-center">
			...
			<?php if(!empty($post_listing_1_element_description)){ ?>
				<p>
					<?php echo wp_kses($post_listing_1_element_description,'string'); ?>
				</p>
			<?php } ?>
		</div>
	<?php } ?>
