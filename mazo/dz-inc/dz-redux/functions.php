...
if(!function_exists('mazo_get_page_template_options')){
	function mazo_get_page_template_options(){
		$result = array();
		$page_template_options = mazo_page_template_options();
...
if(!function_exists('mazo_get_coming_template_options')){
	function mazo_get_coming_template_options(){
		$result = array();
		$page_template_options = mazo_page_template_options();
...
if(!function_exists('mazo_get_maintenance_template_options')){
	function mazo_get_maintenance_template_options(){
		$result = array();
		$page_template_options = mazo_page_template_options();
...
if(!function_exists('mazo_get_error_template_options')){
	function mazo_get_error_template_options(){
		$result = array();
		$page_template_options = mazo_page_template_options();
...
if(!function_exists('mazo_get_header_style_options')){
	function mazo_get_header_style_options(){
		$result = array();
...
if(!function_exists('mazo_get_footer_style_options')){
	function mazo_get_footer_style_options(){
		$result = array();
...
if(!function_exists('mazo_get_sidebar_layout_options')){
	function mazo_get_sidebar_layout_options(){
		$result = array();
		$sidebar_layout_options = mazo_sidebar_layout_options();
...
if(!function_exists('mazo_get_post_layouts_options')){
	function mazo_get_post_layouts_options(){
		$result = array();
		$post_layouts_options = mazo_post_layouts_options();
...
if(!function_exists('mazo_get_post_related_layout_options')){
	function mazo_get_post_related_layout_options(){
		$result = array();
		$post_related_layout_options = mazo_post_related_layout_options();
...
if(!function_exists('mazo_get_post_wrapper_options')){
	function mazo_get_post_wrapper_options(){
		$result = array();
		$post_wrapper_options = mazo_post_wrapper_options();
...
if(!function_exists('mazo_get_post_listing_options')){
	function mazo_get_post_listing_options(){
		$result = array();
		$post_listing_options = mazo_post_listing_options();
...
if(!function_exists('mazo_get_page_banner_layout_options')){
	function mazo_get_page_banner_layout_options(){
		$result = array();
		$page_banner_layout_options = mazo_page_banner_layout_options();
...
if(!function_exists('mazo_get_post_tiles_options')){
	function mazo_get_post_tiles_options(){
		$result = array();
		$post_tiles_options = mazo_post_tiles_options();
...
if(!function_exists('mazo_get_page_banner_options')){
	function mazo_get_page_banner_options(){
		$result = array();
		$page_banner_options = mazo_page_banner_options();
...
if(!function_exists('mazo_get_post_banner_options')){
	function mazo_get_post_banner_options(){
		$result = array();
		$post_banner_options = mazo_post_banner_options();
...
if(!function_exists('mazo_get_theme_layout_options')){
	function mazo_get_theme_layout_options(){
		$result = array();
		$theme_layout_options = mazo_theme_layout_options();
...
if(!function_exists('mazo_get_theme_color_background_options')){
	function mazo_get_theme_color_background_options(){
		$result = array();
		$theme_color_background_options = mazo_theme_color_background_options();
...
if(!function_exists('mazo_get_theme_image_background_options')){
	function mazo_get_theme_image_background_options(){
		$result = array();
		$theme_image_background_options = mazo_theme_image_background_options();
...
if(!function_exists('mazo_get_theme_pattern_background_options')){
	function mazo_get_theme_pattern_background_options(){
		$result = array();
		$theme_pattern_background_options = mazo_theme_pattern_background_options();
...
if(!function_exists('mazo_get_theme_color_options')){
	function mazo_get_theme_color_options(){
		$result = array();
		$theme_color_options = mazo_theme_color_options();
...
if(!function_exists('mazo_get_page_loader_options')){
	function mazo_get_page_loader_options(){
		$result = array();
		$page_loader_options = mazo_page_loader_options();
...
if(!function_exists('mazo_get_sort_by_options')){
	function mazo_get_sort_by_options(){
		$sort_by_options = mazo_sort_by_options();
		return $sort_by_options;
	}
}

if(!function_exists('mazo_get_link_target_options')){
	function mazo_get_link_target_options(){
		$link_target_options = mazo_link_target_options();
		return $link_target_options;
	}
}

if(!function_exists('mazo_get_adsence_size_options')){
	function mazo_get_adsence_size_options(){
		$adsence_size_options = mazo_adsence_size_options();
		return $adsence_size_options;
	}
}

if(!function_exists('mazo_get_social_link_options')){
	function mazo_get_social_link_options(){
		$social_link_options = mazo_social_link_options();
		return $social_link_options;
	}
}

if(!function_exists('mazo_get_social_share_options')){
	function mazo_get_social_share_options(){
		$social_share_options = mazo_social_share_options();
		return $social_share_options;
	}
}

if(!function_exists('mazo_get_theme_option')){
	
	function mazo_get_theme_option($default = array()) {
...
if(!function_exists('mazo_get_fontawesome_icon'))
{
	
	function mazo_get_fontawesome_icon(){
		...
		//$icon_arr = array_combine($icon_arr,$icon_arr);
...
if(!function_exists('mazo_get_flaticon_icon'))
{
				
	function mazo_get_flaticon_icon(){
		$flaticons = array ('flaticon-employee','flaticon-briefing','flaticon-automobile','flaticon-stones',			'flaticon-agronomy','flaticon-nuclear-power','flaticon-oil-pump','flaticon-setting','flaticon-crane','flaticon-email','flaticon-smile','flaticon-call','flaticon-box','flaticon-gift','flaticon-quote','flaticon-calendar','flaticon-user','flaticon-share','flaticon-share-1','flaticon-visibility',
		'flaticon-right-arrow','flaticon-left-arrow','flaticon-down-arrow','flaticon-up-arrow',
		'flaticon-placeholder','flaticon-group','flaticon-processor','flaticon-practice',
		'flaticon-customer-support','flaticon-heart','flaticon-speech-bubble','flaticon-play',
		'flaticon-quotation','flaticon-reply','flaticon-mail','flaticon-phone-call','flaticon-analytics','flaticon-coffee-cup','flaticon-chevron','flaticon-chevron-1','flaticon-control-system','flaticon-settings');
...
if(!function_exists('mazo_get_themify_icon'))
{
	
	function mazo_get_themify_icon(){
		$themify = array (
